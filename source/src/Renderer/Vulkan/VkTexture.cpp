...
void CopyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width, uint32_t height) {
    VkCommandBuffer commandBuffer = BeginSingleTimeCommands(VkContext::GetCommandPool());
    ...
    EndSingleTimeCommands(VkContext::GetCommandPool(),commandBuffer);
}
...
VkImageView CreateImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags)
{
    ...
    if (vkCreateImageView(VkContext::GetDevice(), &viewInfo, nullptr, &imageView) != VK_SUCCESS) {
