...
void CreateGraphicsPipeline(const VkDescriptorSetLayout& descriptorSetLayout,const VkRenderPass& renderPass,VkPipelineLayout* pipelineLayout , VkPipeline* graphicpipiline)
{
	...
	if (vkCreatePipelineLayout(VkContext::GetDevice(), &pipelineLayoutInfo, nullptr, pipelineLayout) != VK_SUCCESS) {
	...
	if (vkCreateGraphicsPipelines(VkContext::GetDevice(), VK_NULL_HANDLE, 1, &pipelineInfo, nullptr, graphicpipiline) != VK_SUCCESS) {
