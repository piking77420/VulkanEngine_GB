...
void ImguiVulkan::Init()
{
    ...
    VkResult err = glfwCreateWindowSurface(g_Instance, VulkanRendererData::window, g_Allocator, &surface);
    check_vk_result(err);
 
    // Create Framebuffers
    int w, h;
    glfwGetFramebufferSize(VulkanRendererData::window, &w, &h);
    ...
    ImGui_ImplGlfw_InitForVulkan(VulkanRendererData::window, true);
...
void ImguiVulkan::CleanupVulkan()
{
